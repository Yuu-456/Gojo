...
from Gojo import OWNER_ID, SUPPORT_CHAT, telethn
from Gojo.events import register
from PIL import Image, ImageDraw, ImageFont

LOGO_LINKS1 [ "https://telegra.ph/file/98bf31ab534bbaf75267a.jpg",
...
async def lego(event):
 ...
 if event.sender_id == OWNER_ID:
  ...
  if not quew:
     ...
     return
 pesan = await event.reply( " Creating your shit . ait bru- ")
 try:
    ...
    fname = "gojo.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by @gojoxprobot")         
    await pesan.delete()
